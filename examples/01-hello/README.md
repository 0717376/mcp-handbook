...
`params` опущены — для этого метода они опциональные. Если у сервера много tool'ов, здесь появится `cursor` для пагинации (разберём в [`05-resources/`](../05-resources/)).
